...
const SingerPage = () => {
	...
	useEffect(() => {
		...
		let rate = document.querySelector('.t-page__info__rate');
		...
		<div className="book-page" id={id}>
			<main>
				<div className="t-page">
					<div className="t-page__image">
						<img src={book.image} alt="" />
					</div>
					<div className="t-page__info">
						<h2 className="t-page__info__title">{book.title}</h2>
						<div className="t-page__info__rate"></div>
						<div className="t-page__info__describe">
							{book.describe}
						</div>

						<button className="t-page__info__content">
